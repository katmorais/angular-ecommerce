...

  {
    ...
    children: [
      ...
      },
      {
        ...
        component: TransportadoraFormComponent,
        resolve: {transportadora: transportadoraResolver}
      },
      ...
      {
        path: 'tipocamisetas/new',
        component: TipoCamisetaFormComponent,
        title: 'Novo Tipo de Camiseta',
        canActivate: [authGuard]
      },
      {
        path: 'tipocamisetas/edit/:id',
        component: TipoCamisetaFormComponent,
        resolve: {tipoCamiseta: tipocamisetaResolver}
      },
